...
import supportImg from '../../images/Office - 69952.mp4';

const Support = () => {
  return (
  <div name='support' className='w-full mt-24'>
      <div className='w-full h-[700px] bg-gray-900/90 absolute'>
        <video className='w-full h-full object-cover mix-blend-overlay' src={supportImg} alt="/" autoPlay
				loop
				muted />
      </div>
      ...
      <div className='max-w-[1240px] mx-auto text-white relative'>
          ...
          <div className='grid grid-cols-1 lg:grid-cols-3 relative gap-x-8 gap-y-16 px-4 pt-12 sm:pt-20 text-black'>
              <div className='bg-white rounded-xl shadow-2xl'>
                  <div className='p-8'>
                      <BsFillTelephoneFill className='w-16 p-4 bg-indigo-600 text-white rounded-lg mt-[-4rem]' />
                      <h3 className='font-bold text-2xl my-6'>Field Services</h3>
              ...
              <div className='bg-white rounded-xl shadow-2xl'>
                  <div className='p-8'>
                      <BiSupport className='w-16 p-4 bg-indigo-600 text-white rounded-lg mt-[-4rem]' />
